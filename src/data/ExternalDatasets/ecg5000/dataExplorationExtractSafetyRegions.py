...
classData[0].transpose().sample(n=50, axis=1).iloc[1:, :].plot(
    ax=ax, legend=False, alpha=0.5, grid=True, color='blue', linewidth=0.5)
classData[1].transpose().sample(n=50, axis=1).iloc[1:, :].plot(
    ax=ax, legend=False, alpha=0.5, grid=True, color='blue', linewidth=0.5)
classData[2].transpose().sample(n=5, axis=1).iloc[1:, :].plot(
    ax=ax, legend=False, alpha=0.05, grid=True, color='blue', linewidth=0.5)
...
plt.plot(
    range(
        1,
        141),
    class0Bounds.transpose().iloc[0].values,
    color='red',
    linewidth=2.0)
plt.plot(
    range(
        1,
        141),
    class0Bounds.transpose().iloc[1].values,
    color='red',
    linewidth=2.0)
...
plt.plot(
    range(
        1,
        141),
    class1Bounds.transpose().iloc[0].values,
    color='yellow',
    linewidth=2.0)
plt.plot(
    range(
        1,
        141),
    class1Bounds.transpose().iloc[1].values,
    color='yellow',
    linewidth=2.0)
