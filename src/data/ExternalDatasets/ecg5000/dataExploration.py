...
# plt.plot(range(1,141), class0Bounds.transpose().iloc[0].values, color = 'red')
# plt.plot(range(1,141), class0Bounds.transpose().iloc[1].values, color = 'red')
# plt.plot(range(1,141), class0Mean, color = 'red')


# plt.plot(range(1,141), class1Bounds.transpose().iloc[0].values, color = 'yellow')
# plt.plot(range(1,141), class1Bounds.transpose().iloc[1].values, color = 'yellow')
# plt.plot(range(1,141), class1Mean, color = 'yellow')
