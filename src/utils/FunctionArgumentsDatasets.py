...
{"objectType": sampleBoxTest,
    "arguments": {'seed': [seed],
                  'purposeFlg': ['test'],
                  'box': [[[math.sin((2 * math.pi * x) / (3 * algorithmInputLayerSize)) - 0.1,
                            math.sin((2 * math.pi * x) / (3 * algorithmInputLayerSize)) + 0.1] for x in range(algorithmInputLayerSize,
                                                                                                              2 * algorithmInputLayerSize)]],
                  'numPoints': [10],
                  }},
