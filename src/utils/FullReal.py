...
# Boxes:
class0_0_35_bottom = [[0.75, 1.25], [-1.01, -0.51], [-2.71, -2.21], [-3.63, -3.13], [-4.23, -3.73], [-4.15, -3.65], [-3.60, -3.10], [-2.62, -2.12], [-1.91, -1.41], [-1.44, -0.94], [-0.91, -0.41], [-0.56, -0.06], [-0.49, 0.01], [-0.46, 0.04], [-0.46, 0.04], [-0.48, 0.02], [-0.40, 0.10],
...
class0_36_70_bottom = [[-0.78, -0.28], [-0.78, -0.28], [-0.84, -0.34], [-0.82, -0.32], [-0.78, -0.28], [-0.75, -0.25], [-0.67, -0.17], [-0.64, -0.14], [-0.57, -0.07], [-0.46, 0.04], [-0.39, 0.11], [-0.36, 0.14], [-0.31, 0.19], [-0.29, 0.21], [-0.23, 0.27], [-0.15, 0.35],
                                                                                                                                ...
                                                                                                                                0.76, 1.26], [
                                                                                                                                    0.96, 1.46], [
                                                                                                                                        1.13, 1.63], [
                                                                                                                                            1.24, 1.74], [
                                                                                                                                                1.27, 1.77]]
class0_106_140_up = [[1.27, 1.77], [1.25, 1.75], [1.13, 1.63], [0.98, 1.48], [0.80, 1.30], [0.59, 1.09], [0.34, 0.84], [0.08, 0.58], [-0.11, 0.39], [-0.18, 0.32], [-0.25, 0.25], [-0.32, 0.18], [-0.41, 0.09], [-0.44, 0.06], [-0.42, 0.08], [-0.42, 0.08], [-0.46, 0.04],
...
class1_0_35_up = [[1.75, 2.25], [-0.47, 0.03], [-1.29, -0.79], [-1.82, -1.32], [-2.51, -2.01], [-2.74, -2.24], [-2.82, -2.32], [-2.67, -2.17], [-2.40, -1.90], [-1.98, -1.48], [-1.55, -1.05], [-1.26, -0.76], [-1.01, -0.51], [-0.74, -0.24], [-0.49, 0.01], [-0.29, 0.21],
                                                                                                                                ...
                                                                                                                                0.44, 0.94], [
                                                                                                                                    0.45, 0.95], [
                                                                                                                                        0.48, 0.98], [
                                                                                                                                            0.48, 0.98], [
                                                                                                                                                0.50, 1.00]]
class1_106_140_bottom = [[0.50, 1.00], [0.48, 0.98], [0.48, 0.98], [0.49, 0.99], [0.51, 1.01], [0.50, 1.00], [0.51, 1.01], [0.52, 1.02], [0.49, 0.99], [0.46, 0.96], [0.43, 0.93], [0.40, 0.90], [0.34, 0.84], [0.28, 0.78], [0.23, 0.73], [0.19, 0.69], [0.13, 0.63], [
...
def getResults():
    results = [
        ...
        maxLInftyErrorEst(sampleSizes=[2**k for k in range(10, 20)], boundingBox=class0_0_35_bottom),
        maxLInftyErrorEst(sampleSizes=[2**k for k in range(10, 20)], boundingBox=class0_36_70_bottom),
        maxLInftyErrorEst(sampleSizes=[2**k for k in range(10, 20)], boundingBox=class0_71_105_up),
        maxLInftyErrorEst(sampleSizes=[2**k for k in range(10, 20)], boundingBox=class0_106_140_up),
        maxLInftyErrorEst(sampleSizes=[2**k for k in range(10, 20)], boundingBox=class1_0_35_up),
        maxLInftyErrorEst(sampleSizes=[2**k for k in range(10, 20)], boundingBox=class1_36_70_up),
        maxLInftyErrorEst(sampleSizes=[2**k for k in range(10, 20)], boundingBox=class1_71_105_bottom),
        maxLInftyErrorEst(sampleSizes=[2**k for k in range(10, 20)], boundingBox=class1_106_140_bottom),

        maxErrorEst(sampleSizes=[2**k for k in range(10, 20)], boundingBox=class0_0_35_bottom),
        maxErrorEst(sampleSizes=[2**k for k in range(10, 20)], boundingBox=class0_36_70_bottom),
        maxErrorEst(sampleSizes=[2**k for k in range(10, 20)], boundingBox=class0_71_105_up),
        maxErrorEst(sampleSizes=[2**k for k in range(10, 20)], boundingBox=class0_106_140_up),
        maxErrorEst(sampleSizes=[2**k for k in range(10, 20)], boundingBox=class1_0_35_up),
        maxErrorEst(sampleSizes=[2**k for k in range(10, 20)], boundingBox=class1_36_70_up),
        maxErrorEst(sampleSizes=[2**k for k in range(10, 20)], boundingBox=class1_71_105_bottom),
        maxErrorEst(sampleSizes=[2**k for k in range(10, 20)], boundingBox=class1_106_140_bottom),
